...
void QSS::UdpRelay::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<UdpRelay *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (UdpRelay::*)(quint64 );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UdpRelay::bytesRead)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (UdpRelay::*)(quint64 );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UdpRelay::bytesSend)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QSS::UdpRelay::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QSS__UdpRelay.data,
    qt_meta_data_QSS__UdpRelay,
    qt_static_metacall,
    nullptr,
    nullptr
} };
