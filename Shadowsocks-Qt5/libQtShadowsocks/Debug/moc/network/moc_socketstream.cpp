...
void QSS::SocketStream::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SocketStream *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject QSS::SocketStream::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QSS__SocketStream.data,
    qt_meta_data_QSS__SocketStream,
    qt_static_metacall,
    nullptr,
    nullptr
} };
