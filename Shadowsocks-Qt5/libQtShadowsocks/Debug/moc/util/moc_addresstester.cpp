...
void QSS::AddressTester::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<AddressTester *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (AddressTester::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AddressTester::lagTestFinished)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (AddressTester::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AddressTester::testErrorString)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (AddressTester::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AddressTester::connectivityTestFinished)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QSS::AddressTester::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QSS__AddressTester.data,
    qt_meta_data_QSS__AddressTester,
    qt_static_metacall,
    nullptr,
    nullptr
} };
