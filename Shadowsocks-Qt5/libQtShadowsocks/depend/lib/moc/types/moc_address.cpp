...
void QSS::DnsLookup::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<DnsLookup *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (DnsLookup::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DnsLookup::finished)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QSS::DnsLookup::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QSS__DnsLookup.data,
    qt_meta_data_QSS__DnsLookup,
    qt_static_metacall,
    nullptr,
    nullptr
} };
