...
void QSS::Controller::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Controller::runningStateChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Controller::*)(quint64 );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Controller::newBytesReceived)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (Controller::*)(quint64 );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Controller::newBytesSent)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (Controller::*)(quint64 );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Controller::bytesReceivedChanged)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (Controller::*)(quint64 );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Controller::bytesSentChanged)) {
                *result = 4;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Controller::tcpLatencyAvailable)) {
                *result = 5;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QSS::Controller::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QSS__Controller.data,
    qt_meta_data_QSS__Controller,
    qt_static_metacall,
    nullptr,
    nullptr
} };
