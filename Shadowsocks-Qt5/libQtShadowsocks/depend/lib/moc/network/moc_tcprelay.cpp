...
QT_MOC_LITERAL(8, 102, 21), // "onLocalTcpSocketError"
QT_MOC_LITERAL(9, 124, 25), // "onLocalTcpSocketReadyRead"
QT_MOC_LITERAL(10, 150, 26), // "onRemoteTcpSocketReadyRead"
...
QT_MOC_LITERAL(12, 187, 5) // "close"
    ...
    "onRemoteTcpSocketError\0onLocalTcpSocketError\0"
    "onLocalTcpSocketReadyRead\0"
    "onRemoteTcpSocketReadyRead\0onTimeout\0"
    "close"
};
...
void QSS::TcpRelay::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<TcpRelay *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        case 6: _t->onLocalTcpSocketError(); break;
        case 7: _t->onLocalTcpSocketReadyRead(); break;
        case 8: _t->onRemoteTcpSocketReadyRead(); break;
        ...
        {
            using _t = void (TcpRelay::*)(quint64 );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TcpRelay::bytesRead)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (TcpRelay::*)(quint64 );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TcpRelay::bytesSend)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (TcpRelay::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TcpRelay::latencyAvailable)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (TcpRelay::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TcpRelay::finished)) {
                *result = 3;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QSS::TcpRelay::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QSS__TcpRelay.data,
    qt_meta_data_QSS__TcpRelay,
    qt_static_metacall,
    nullptr,
    nullptr
} };
