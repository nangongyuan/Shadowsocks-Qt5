...
void QRCodeCapturer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QRCodeCapturer *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QRCodeCapturer::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QRCodeCapturer::qrCodeFound)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QRCodeCapturer::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QRCodeCapturer::closed)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QRCodeCapturer::staticMetaObject = { {
    &QMainWindow::staticMetaObject,
    qt_meta_stringdata_QRCodeCapturer.data,
    qt_meta_data_QRCodeCapturer,
    qt_static_metacall,
    nullptr,
    nullptr
} };
