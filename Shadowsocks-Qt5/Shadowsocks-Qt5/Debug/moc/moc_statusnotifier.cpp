...
QT_MOC_LITERAL(4, 42, 22), // "onWindowVisibleChanged"
QT_MOC_LITERAL(5, 65, 7) // "visible"

    },
    "StatusNotifier\0activate\0\0showNotification\0"
    "onWindowVisibleChanged\0visible"
};
...
void StatusNotifier::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<StatusNotifier *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->activate(); break;
        case 1: _t->showNotification((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 2: _t->onWindowVisibleChanged((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    }
}
