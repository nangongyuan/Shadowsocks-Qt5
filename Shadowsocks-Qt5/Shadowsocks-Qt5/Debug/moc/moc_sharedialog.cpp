...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ShareDialog_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ShareDialog_t qt_meta_stringdata_ShareDialog = {
    {
QT_MOC_LITERAL(0, 0, 11), // "ShareDialog"
QT_MOC_LITERAL(1, 12, 19), // "onSaveButtonClicked"
QT_MOC_LITERAL(2, 32, 0) // ""

    },
    "ShareDialog\0onSaveButtonClicked\0"
};
...
QT_INIT_METAOBJECT const QMetaObject ShareDialog::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_ShareDialog.data,
    qt_meta_data_ShareDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ShareDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ShareDialog.stringdata0))
